    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ticket_Comments", x => x.CommentId);
                    table.ForeignKey(
                        name: "FK_Ticket_Comments_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ticket_History", x => x.HistoryId);
                    table.ForeignKey(
                        name: "FK_Ticket_History_AspNetUsers_ChangedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ticket_Comments_CreatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ticket_History_ChangedById",
